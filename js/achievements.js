(function () {
  ...
  function renderBadgeCard(badge) {
    ...
    var progressBar = "";
    var countableTypes = ["expense_count", "streak", "streak_diamonds", "level", "goal_count", "goals_completed",
      "category_variety", "mission_count", "quest_count", "quest_streak", "savings_total", "budget_weeks_total"];
  ...
  function renderBadgeGrid() {
    ...
    gridEl.querySelectorAll(".badge-claim-btn").forEach(function (btn) {
      btn.addEventListener("click", function (e) {
        e.stopPropagation();
        openClaimSheet(btn.getAttribute("data-badge-id"), allBadges);
      });
    });
  }
